--[[
   ...
   information, see COPYING.
	...
	ProducedUnitTypes =
	{
		...
		{ factory = SovietWarFactory1, types = { "3tnk", "4tnk", "v2rl", "ttnk", "btr" } }
	}

ShipUnitTypes = { "1tnk", "1tnk", "jeep", "2tnk", "2tnk" }
HelicopterUnitTypes = { "e1", "e1", "mgi", "e1", "e3", "e3" };
...
ChronoshiftAlliedUnits = function()
	...
	local units = { }
	for i = 1, #cells do
		local unit = Actor.Create("tnkd", true, { Owner = allies, Facing = 0 })
		BindActorTriggers(unit)
		units[unit] = cells[i]
	end
